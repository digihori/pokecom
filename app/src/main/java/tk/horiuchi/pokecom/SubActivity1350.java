...
public class SubActivity1350 extends SubActivityBase {
    //private boolean _04game;

    private final int BASIC_TEXT_START  = 0x2030;
    private final int BASIC_START_ADR_L = 0x6f01;
    private final int BASIC_START_ADR_H = 0x6f02;
    private final int BASIC_END_ADR_L   = 0x6f03;
    private final int BASIC_END_ADR_H   = 0x6f04;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instance = this;
        activityId = 1350;
        setContentView(R.layout.activity_main_1350);

        SurfaceView sv = (SurfaceView) findViewById(R.id.surfaceView);
        ml = new MainLoop1350(this, sv);
