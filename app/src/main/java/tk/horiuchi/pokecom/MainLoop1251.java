...
public class MainLoop1251 extends MainLoopBase {
    ...
    public MainLoop1251(Context context, SurfaceView sv) {
        super(context, sv);
        ...
        // cpuオブジェクトの生成
        sc = new Sc61860_1251(context);
        sc.setListener(this);
        sc.CpuReset();

        Log.w("LOG", "MainLoop1251 started.");
    }
