...
public class KeyBoard1470 extends KeyboardBase {
    ...
    public KeyBoard1470() {
        ...
        // スキャンテーブルの初期化
        scandef = new int[] {
                R.id.button7,R.id.button8,R.id.button9,R.id.buttonDIV,R.id.buttonDEL,KNUL,KNUL,KNUL,
                R.id.button4,R.id.button5,R.id.button6,R.id.buttonMLT,R.id.buttonBS,R.id.buttonSHIFT,R.id.buttonDEF,R.id.buttonSML,
                R.id.button1,R.id.button2,R.id.button3,R.id.buttonMINUS,R.id.buttonINS,R.id.buttonQ,R.id.buttonA,R.id.buttonZ,
                ...
                KNUL,   KNUL,   KNUL,   KNUL,   KNUL,   KNUL,   KNUL,   R.id.buttonCAL
        };
