...
public class SubActivity1450 extends SubActivityBase {

    private final int BASIC_TEXT_START  = 0x2030;   // 32k
    private final int BASIC_START_ADR_L = 0x5f01;
    private final int BASIC_START_ADR_H = 0x5f02;
    private final int BASIC_END_ADR_L   = 0x5f03;
    private final int BASIC_END_ADR_H   = 0x5f04;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instance = this;
        activityId = 1450;
        setContentView(R.layout.activity_main_1450);


        SurfaceView sv = (SurfaceView) findViewById(R.id.surfaceView);
        ml = new MainLoop1450(this, sv);
        ...
        cmd_tbl = new String[] {
                ...
                "GOSUB", "AREAD", "LPRINT", "RETURN", "RESTORE", "CHAIN", "\0", "\0", "\0", "\0", "\0", "\0", "BASIC", "TEXT", "OPEN$", "\\EX",
