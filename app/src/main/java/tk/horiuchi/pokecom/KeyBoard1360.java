...
public class KeyBoard1360 extends KeyboardBase {
    public KeyBoard1360() {
        super();
        ...
        // スキャンテーブルの初期化
        scandef = new int[] {
                R.id.buttonCLN,R.id.buttonSCLN,KNUL,KNUL,R.id.buttonSML,R.id.buttonDEF,R.id.buttonSHIFT,KNUL,
                R.id.buttonCOMMA,R.id.buttonDIV,R.id.buttonMLT,R.id.buttonMINUS,R.id.buttonZ,R.id.buttonA,R.id.buttonQ,KNUL,
                ...
                R.id.buttonCOMMA,R.id.buttonKANA,R.id.buttonDA,R.id.buttonUA,R.id.buttonB,R.id.buttonG,R.id.buttonT,KNUL,
                KNUL,R.id.buttonMODE,R.id.buttonRA,R.id.buttonLA,R.id.buttonN,R.id.buttonH,R.id.buttonY,KNUL,

                KNUL,   KNUL,   R.id.buttonCE,R.id.buttonDEL,R.id.buttonM,R.id.buttonJ,R.id.buttonU,KNUL,
                KNUL,   KNUL,   KNUL,   R.id.buttonINS,R.id.buttonSPC,R.id.buttonK,R.id.buttonI,KNUL,
